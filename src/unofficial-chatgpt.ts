...
Create a summary in English, regardless of the original language, in about 50 words.
...
If program code is provided, give a concise description of the input and output.
